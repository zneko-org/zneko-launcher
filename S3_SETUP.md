...
| Setting | Value |
| --- | --- |
| Bucket Unique Name | Pick your own unique name |
| Files in Bucket are | **Private** |
| Default Encryption | **Disable** |
| Object Lock | **Disable** |

Choose your own bucket name. Names are unique across all of Backblaze, not just your account. Pick a name with at least 6 characters and use it everywhere below.
...
| Setting | Value |
| --- | --- |
| Name of Key | Any name of your choice |
| Allow access to Bucket(s) | Your bucket name |
| Type of Access | **Read and Write** |

The key name is just a label for your own reference in Backblaze. Leave the remaining optional fields empty, then click **Create New Key**.
...
```
s3://005a1b2c3d4e5f60000000001:K005AbCdEfGhIjKlMnOpQrStUvWxYz0@s3.us-east-005.backblazeb2.com/your-bucket-name
```
...
ZNeko checks the whole configuration with a single request before saving it. If something is wrong it says which part: a rejected key pair, a bucket that is not there, or an endpoint that could not be reached. The provider's own error code is shown underneath.
---
